;	MS-BASIC for 8080
;	inported from SBC8080 data pack written by Tetsuya Suzuki
;	http://www.amy.hi-ho.ne.jp/officetetsu/storage/sbc8080_datapack.zip
;
;	Modified by Gazelle 2022 Nov. 12
;	remove console I/O and add org 2200h for merge with extended monitor
;	added "CPU Z80" for use ASW.EXE
...
;
SIGNON: DB	"INTEL8080 BASIC Ver 4.7b",CR,LF
...
COUNT:	PUSH	HL		; Save code string address
	...
	LD	DE,-1
;	ADC	HL,DE		; Decrement
	LD	A,E		;REPLACE Z80 CODE
	ADC	A,L		;REPLACE Z80 CODE
	LD	L,A		;REPLACE Z80 CODE
	LD	A,D		;REPLACE Z80 CODE
	ADC	A,H		;REPLACE Z80 CODE
	LD	H,A		;REPLACE Z80 CODE
;
...
;	LD	(LINESN),DE	; Set lines number
	EX	DE,HL		; REPLACE Z80 CODE
        LD      (LINESC),HL     ; REPLACE Z80 CODE
        LD      (LINESN),HL     ; REPLACE Z80 CODE
	EX	DE,HL		; REPLACE Z80 CODE
	RET
;
...
;	RL	D
	LD	A,E		; REPLACE Z80 CODE
	RLA			; REPLACE Z80 CODE
	LD	E,A		; REPLACE Z80 CODE
	LD	A,D		; REPLACE Z80 CODE
	RLA			; REPLACE Z80 CODE
	LD	D,A		; REPLACE Z80 CODE
	JP	NC,ZEROSUP
	JP	BITOUT2
BITOUT:	
;	RL	E
